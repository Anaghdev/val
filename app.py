...
# ---------------- PAGE CONFIG ----------------
st.set_page_config(page_title="A Proposal for Liya 💍", layout="centered", page_icon="💍")
...
# HEADER
st.markdown("<div class='romantic-title'>Will You Be Mine?</div>", unsafe_allow_html=True)
st.markdown("<div style='text-align:center;'><span class='sub-title'>MY HEART BELONGS TO YOU</span></div>", unsafe_allow_html=True)
...
<div class='glass-card' data-tilt>
    ...
    <br><br>
    From the moment you entered my life, you've been my everything. Today, on this Propose Day, I have but one question for you...
    <br>
    <strong>Will you make me the happiest person alive?</strong>
    </p>
</div>
""", unsafe_allow_html=True)
...
if st.session_state.rose_accepted:
    ...
    if os.path.exists("rose.json"):
        ...
        # Keeping the rose animation for stability, updated context makes it work
